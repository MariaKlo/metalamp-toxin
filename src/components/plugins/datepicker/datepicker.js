...
class Datepicker {
  ...
  callDatepickerPlugin() {
    for (let i = 0; i < this.datepickerId.length; i++) {
      let datePlugin = new AirDatepicker(this.datepickerId[i], {
    ...
    for (let i = 0; i < this.datepickerIdWithRange.length; i++) {
      let datePlugin = new AirDatepicker(this.datepickerIdWithRange[i], {
        range: true,
...
let datepickerPlugin = new Datepicker();